...
public class PressurePlate : MonoBehaviour
{
    ...
    public void TurnOn(Collider2D col)
    {
        ...
        if (elevator != null && (col.CompareTag("Player") || col.CompareTag("LittleBuddy") || col.CompareTag("Moveable") || col.CompareTag("MetalBox") || col.CompareTag("Nonmoveable")))
        {
            isOn = true;
        ...
        if (door != null && (col.CompareTag("Player") || col.CompareTag("LittleBuddy") || col.CompareTag("Moveable") || col.CompareTag("MetalBox") || col.CompareTag("Nonmoveable")))
        {
            isOn = true;
        ...
        if (wall != null && (col.CompareTag("Player") || col.CompareTag("LittleBuddy") || col.CompareTag("Moveable") || col.CompareTag("MetalBox") || col.CompareTag("Nonmoveable")))
        {
            isOn = true;
    ...
    public void OnTriggerEnter2D(Collider2D col)
    {
        ...
        {
            if (col.CompareTag("Player") || col.CompareTag("LittleBuddy") || col.CompareTag("Moveable") || col.CompareTag("MetalBox") || col.CompareTag("Nonmoveable"))
            {
